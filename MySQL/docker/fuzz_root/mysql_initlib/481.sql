...
SELECT CREATE_OPTIONS FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='t1' OR TABLE_NAME='t2';
DROP TABLE t1;
DROP TABLE t2;
CREATE TEMPORARY TABLE t1 ( a INTEGER NOT NULL DEFAULT 1, b INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY, c INTEGER, d INTEGER GENERATED ALWAYS AS (a * 2) STORED, e POINT NOT NULL SRID 0, f CHAR(30), g INT, h TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, KEY(g), SPATIAL KEY(e), FULLTEXT(f)) engine=myisam;
