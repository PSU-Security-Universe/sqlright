...
SELECT * FROM t1 ORDER BY s1;
DROP TABLE t1;
CREATE TABLE `t1` ( `ID` smallint(5) unsigned zerofill NOT NULL AUTO_INCREMENT, `Post` enum('','B','O','Z','U') COLLATE latin2_czech_cs DEFAULT NULL, PRIMARY KEY (`ID`) ) ENGINE=MyISAM AUTO_INCREMENT=135 DEFAULT CHARSET=latin2;
