set names latin1;
CREATE TABLE t1 (`a` INT, `b` INT, `C` INT, `D` INT, `á` INT, `é` INT, `Á` INT, `Å` INT, `ê` INT, KEY `a` ( `a` ), KEY `b` ( `b` ), KEY `C` ( `C` ), KEY `D` ( `D` ), KEY `á` ( `á` ), KEY `é` ( `é` ), KEY `Á` ( `Á` ), KEY `Å` ( `Å` ), KEY `ê` ( `ê` ));
CREATE TABLE t2 (`ê` INT, `Å` INT, `Á` INT, `é` INT, `á` INT, `D` INT, `C` INT, `b` INT, `a` INT, KEY `ê` ( `ê` ), KEY `Á` ( `Á` ), KEY `Å` ( `Å` ), KEY `é` ( `é` ), KEY `á` ( `á` ), KEY `D` ( `D` ), KEY `C` ( `C` ), KEY `b` ( `b` ), KEY `a` ( `a` ));
