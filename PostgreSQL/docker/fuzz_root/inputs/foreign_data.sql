...
CREATE FOREIGN DATA WRAPPER foo VALIDATOR bar;
            ...
            CREATE FOREIGN DATA WRAPPER foo;
\dewCREATE FOREIGN DATA WRAPPER foo;
...
ALTER FOREIGN DATA WRAPPER foo OPTIONS (b '4');
             \dew+SET ROLE regress_test_role;
             \dew+SET ROLE regress_test_role;
...
CREATE USER MAPPING FOR current_user SERVER s1;
 ...
 \dew+\des+\deu+DROP FOREIGN DATA WRAPPER foo;
                              SET ROLE regress_test_role;
                              SET ROLE regress_test_role;
...
DROP ROLE regress_test_indirect;
                            \des+ALTER SERVER s8 RENAME to s8new;
                            \des+ALTER SERVER s8 RENAME to s8new;
...
\deuDROP SERVER s3;
                                             ...
                                             DROP SERVER s3 CASCADE;
\des\deuCREATE USER MAPPING FOR regress_test_missing_role SERVER s1;
  CREATE USER MAPPING FOR current_user SERVER s1;
...
RESET ROLE;
\deuALTER USER MAPPING FOR regress_test_missing_role SERVER s4 OPTIONS (gotcha 'true');
...
ALTER FOREIGN TABLE ft1 ALTER COLUMN xmin OPTIONS (ADD p1 'v1');
 ALTER FOREIGN TABLE ft1 ALTER COLUMN c7 OPTIONS (ADD p1 'v1', ADD p2 'v2'),                        ALTER COLUMN c8 OPTIONS (ADD p1 'v1', ADD p2 'v2');
 ALTER FOREIGN TABLE ft1 ALTER COLUMN c7 OPTIONS (ADD p1 'v1', ADD p2 'v2'),                        ALTER COLUMN c8 OPTIONS (ADD p1 'v1', ADD p2 'v2');
...
\d+ fd_pt2\d+ fd_pt2_1ALTER TABLE fd_pt2 ATTACH PARTITION fd_pt2_1 FOR VALUES IN (1);
