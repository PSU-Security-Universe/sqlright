...
SELECT * FROM check_test(    matches( 'foo'::text, '^a' ),    false,    'matches() fail',    '',    '                  ''foo''   doesn''t match: ''^a''');
...
SELECT * FROM check_test(    doesnt_match( 'foo'::text, 'o' ),    false,    'doesnt_match() fail',    '',    '                  ''foo''         matches: ''o''');
...
SELECT * FROM check_test(    alike( 'foo'::text, 'a%'::text ),    false,    'alike() fail',    '',    '                  ''foo''   doesn''t match: ''a%''');
